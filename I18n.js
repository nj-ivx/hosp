...
window.I18N = {
  en: {
    ...
    th_manage: "Manage",
    stat_my_submissions: "My submissions",
    stat_my_appointments: "My appointments",
    stat_next_appointment: "Next appointment",
    ...
    doctor_bio: "Short bio",
    save: "Save",
    no_doctors: "No doctors listed yet.",
    overview_title: "About this portal",
    overview_desc: "A secure place to manage patient records, book appointments, and connect with our hospitals and doctors.",
    feature1_title: "Digital Records",
    feature1_desc: "Submit and manage patient health records securely.",
    feature2_title: "Easy Booking",
    feature2_desc: "Book appointments with our doctors in minutes.",
    feature3_title: "Multiple Hospitals",
    feature3_desc: "Access care across all our hospital locations.",
    hospitals_title: "Our Hospitals",
    add_hospital: "Add Hospital",
    hospital_name: "Name",
    hospital_phone: "Phone",
    hospital_address: "Address",
    hospital_description: "Description",
    no_hospitals: "No hospitals listed yet.",
    label_hospital: "Hospital",
    label_doctor: "Doctor",
    th_hospital: "Hospital",
    th_doctor: "Doctor",
    select_option: "Select…",
    select_hospital_first: "Choose a hospital first…",
  ...
  ar: {
    ...
    th_manage: "إدارة",
    stat_my_submissions: "طلباتي",
    stat_my_appointments: "مواعيدي",
    stat_next_appointment: "الموعد القادم",
    my_appointments_title: "مواعيدي",
    no_appointments: "لا توجد مواعيد محجوزة بعد.",
    doctors_title: "أطباؤنا",
    add_doctor: "إضافة طبيب",
    doctor_name: "الاسم",
    doctor_department: "القسم",
    doctor_specialty: "التخصص",
    doctor_bio: "نبذة مختصرة",
    save: "حفظ",
    no_doctors: "لا يوجد أطباء مضافون بعد.",
    overview_title: "عن هذه البوابة",
    overview_desc: "مكان آمن لإدارة سجلات المرضى، وحجز المواعيد، والتواصل مع مستشفياتنا وأطبائنا.",
    feature1_title: "سجلات رقمية",
    feature1_desc: "أرسل وأدر سجلات المرضى الصحية بأمان.",
    feature2_title: "حجز سهل",
    feature2_desc: "احجز موعدًا مع أطبائنا خلال دقائق.",
    feature3_title: "مستشفيات متعددة",
    feature3_desc: "احصل على الرعاية عبر جميع مواقع مستشفياتنا.",
    hospitals_title: "مستشفياتنا",
    add_hospital: "إضافة مستشفى",
    hospital_name: "الاسم",
    hospital_phone: "الهاتف",
    hospital_address: "العنوان",
    hospital_description: "الوصف",
    no_hospitals: "لا توجد مستشفيات مضافة بعد.",
    label_hospital: "المستشفى",
    label_doctor: "الطبيب",
    th_hospital: "المستشفى",
    th_doctor: "الطبيب",
    select_option: "اختر…",
    select_hospital_first: "اختر مستشفى أولاً…",
